...
┌ session-a ──────────────────────────────────────┐┌ session-b ──────────────────────────────────────┐
│$ echo hello                                     ││$ top                                            │
│hello                                            ││ PID USER      PR  NI  VIRT   RES  ...          │
│$                                                ││ 123 root      20   0  1234   567  ...          │
│                                                 ││                                                │
└─────────────────────────────────────────────────┘└─────────────────────────────────────────────────┘
 NORMAL  [2/2] session-b | ^A:add ^D:drop ^S:list Tab:next Enter:focus
```
...
│                                                                                 │
└─────────────────────────────────────────────────────────────────────────────────┘
 PICKER  [1/1] session-a | j/k:nav Enter:select Esc:cancel
```
...
│                                    │
└────────────────────────────────────┘
 NORMAL  [3/3] session-c | ^A:add ^D:drop ^S:list Tab:next Enter:focus
```
